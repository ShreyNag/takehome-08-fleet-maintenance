...
urlpatterns = [
    ...
    path("service-records/", views.ServiceRecordListView.as_view(), name="service-record-list"),
    path("service-records/export/", views.ServiceRecordExportView.as_view(), name="service-record-export"),
